...
public class WelcomeControllerTest {
    ...
    List<String> expectedList =  Arrays.asList("DevOps Introduction", "Concept & Principles", "Pipelines with Jenkins", "Groovy & BlueOcean", "Introduction to TeamCity", "Hands-On Sonar", "K8s and Advanced MicroServices");
